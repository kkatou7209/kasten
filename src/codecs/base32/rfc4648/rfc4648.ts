import { Base32 } from '@/codecs/base32';
import { CharCodes } from '@/utils/char-codes';
import { KastenBase32DecodeError } from '@/codecs/base32/errors';
import { textDecoder } from '@/utils/bytes';
...
export class RFC4648Base32 extends Base32 {
    ...
    public override encodeBytes(bytes: Uint8Array): string {
        ...
        return textDecoder.decode(chars.subarray(0, count));
    }
    
    public override decodeString(base32: string): Uint8Array {
